...
**react-todo-app** is a project based on a tutorial to build a todo app, consolidate my knowledge about React, components, props, state, and hooks.
...
```sh
  cd my-folder
  git clone https://github.com/Matthieu96Code/react-todo-app
```
...
Next, switch inside the project directory and run: `npm install`
...
Feel free to check the [issues page](https://github.com/Matthieu96Code/react-todo-app/issues)
...
I would like to thank [ibaslogic](https://ibaslogic.com/react-tutorial-for-beginners/) for the tutorial and [microverse](https://www.microverse.org/) for this opportunity
